...
void AMeleeCombatCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMeleeCombatCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMeleeCombatCharacter::Look);
	}
	else
	{
...
void AMeleeCombatCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMeleeCombatCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
